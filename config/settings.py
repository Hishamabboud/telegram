...
AREA_TRANSLATIONS = {
    ...
    "תל אביב - מרכז העיר": ("Tel Aviv - City Center", "تل أبيب - وسط المدينة"),
    "תל אביב - דרום העיר": ("Tel Aviv - South", "تل أبيب - جنوب المدينة"),
    "תל אביב - צפון הישן": ("Tel Aviv - North (Old)", "تل أبيب - الشمال القديم"),
    "חיפה - כרמל ועיר תחתית": ("Haifa - Carmel & Downtown", "حيفا - الكرمل ووسط المدينة"),
    "חיפה - מערב": ("Haifa - West", "حيفا - الغرب"),
    "חיפה - נווה שאנן": ("Haifa - Neve Sha'anan", "حيفا - نيفيه شأنان"),
    "ירושלים - מרכז": ("Jerusalem - Center", "القدس - المركز"),
    "באר שבע": ("Be'er Sheva", "بئر السبع"),
    "אשדוד": ("Ashdod", "أشدود"),
    "אשקלון": ("Ashkelon", "عسقلان"),
    "שדרות": ("Sderot", "سديروت"),
    "נתיבות": ("Netivot", "نتيفوت"),
    "אופקים": ("Ofakim", "أوفاكيم"),
    "קריית שמונה": ("Kiryat Shmona", "كريات شمونة"),
    "נהריה": ("Nahariya", "نهاريا"),
    "עכו": ("Akko", "عكا"),
    "כרמיאל": ("Karmiel", "كرميئيل"),
    "צפת": ("Safed (Tzfat)", "صفد"),
    "טבריה": ("Tiberias", "طبريا"),
    "עפולה": ("Afula", "العفولة"),
    "מגדל העמק": ("Migdal HaEmek", "مجدال هعيمق"),
    "נצרת": ("Nazareth", "الناصرة"),
    "חדרה": ("Hadera", "الخضيرة"),
    "נתניה": ("Netanya", "نتانيا"),
    "הרצליה": ("Herzliya", "هرتسليا"),
    "רעננה": ("Ra'anana", "رعنانا"),
    "פתח תקווה": ("Petah Tikva", "بيتح تكفا"),
    "ראשון לציון": ("Rishon LeZion", "ريشون لتسيون"),
    "רחובות": ("Rehovot", "رحوفوت"),
    "לוד": ("Lod", "اللد"),
    "רמלה": ("Ramla", "الرملة"),
    "מודיעין": ("Modi'in", "موديعين"),
    "בית שמש": ("Beit Shemesh", "بيت شيمش"),
    "דימונה": ("Dimona", "ديمونا"),
    "ערד": ("Arad", "عراد"),
    "אילת": ("Eilat", "إيلات"),
    "יבנה": ("Yavne", "يفنة"),
    "גדרה": ("Gedera", "جديرا"),
    "קריית גת": ("Kiryat Gat", "كريات جات"),
    "קריית מלאכי": ("Kiryat Malachi", "كريات ملاخي"),
    "רמת גן": ("Ramat Gan", "رمات غان"),
    "בני ברק": ("Bnei Brak", "بني براك"),
    "גבעתיים": ("Givatayim", "جفعاتايم"),
    "חולון": ("Holon", "حولون"),
    "בת ים": ("Bat Yam", "بات يام"),
    "כפר סבא": ("Kfar Saba", "كفار سابا"),
    "רעות": ("Re'ut", "رعوت"),
    "הוד השרון": ("Hod HaSharon", "هود هشارون"),
    "ראש העין": ("Rosh HaAyin", "روش هعاين"),
}
...
# ─── Alert Batching ───
ALERT_BATCH_WINDOW_SECONDS = 30  # Wait 30s after first alert before sending summary

# ─── Strict Israel-Iran War Filter Keywords ───
# Used for news/impact/interception filtering — ONLY Israel-Iran war content
STRICT_WAR_KEYWORDS_EN = [
    "iran", "iranian", "irgc", "hezbollah", "houthis", "houthi",
    "ballistic missile", "cruise missile", "iron dome", "david's sling",
    "arrow missile", "arrow system", "interception over israel",
    "missile attack on israel", "rocket barrage israel",
    "israel intercept", "israel missile", "israel rocket",
    "israel strike", "israel attack", "israel war",
    "iranian attack", "iranian missile", "iranian drone",
    "iran attack", "iran strike", "iran drone",
    "axis of resistance", "proxy attack",
    "tel aviv attack", "haifa attack", "jerusalem attack",
    "idf strike", "idf attack", "idf operation",
    "gaza rocket", "hamas rocket", "hamas missile",
    "lebanon rocket", "lebanon missile",
    "yemen missile", "yemen drone", "yemen attack",
    "red sea attack", "eilat attack",
]

STRICT_WAR_KEYWORDS_HE = [
    "איראן", "איראני", "חיזבאללה", "חות'ים",
    "טיל בליסטי", "טיל שיוט", "כיפת ברזל", "קלע דוד",
    "חץ", "יירוט", "מתקפה איראנית", "מתקפת טילים",
    "התקפת איראן", "מטח טילים", "מטח רקטות",
    "צה\"ל תקף", "צה\"ל תוקף",
]
